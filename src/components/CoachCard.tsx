...
export default function CoachCard({ coach, photoOnly = false }: Props) {
  return (
    <div className="bg-white border border-gray-200 overflow-hidden">
      {/* Photo or silhouette */}
      <div className="aspect-[3/4] overflow-hidden relative bg-snfc-navy">
        {coach.photoUrl ? (
          <img
            src={coach.photoUrl}
            alt={coach.name}
        ...
        >
          <div
            className="inline-block bg-snfc-gold text-snfc-navy text-[10px] font-display font-bold px-1.5 py-0.5 uppercase tracking-wider"
